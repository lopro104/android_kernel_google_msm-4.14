...
/*
 * This msm-4.14 tree backports __poll_t into include/uapi/linux/types.h, so the
 * usual <4.16 fallback would be a redefinition (-Werror,-Wtypedef-redefinition).
 * Same reason infra/file_wrapper.c keeps its copy commented out.
 */
